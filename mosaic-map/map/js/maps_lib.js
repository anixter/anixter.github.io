(function (window, undefined) {
    ...
    var self = this;
    var selectColumns = 'Description, Address1, Address2, Phone, Lat, Lng, BranchNumber ';
        ...
        template = "\
          <div class='row-fluid item-list'>\
            <div class='span12'>\
              ...
              <br />\
              <a target='_blank' class='' href='https://maps.google.com?daddr=" + data[row][1] + " , " + data[row][2] + "'><img src='map/images/directions-icon.png' /> Get Directions</a> \
              <br />\
              <br />\
            </div>\
          </div>";
