(function (window, undefined) {
    var MapsLib = function (options) {
        ...
        this.fusionTableId = options.fusionTableId || "1XkxbwB-yKdiju1vzt6e045FPb2s5MVYujfPSnB1b",
    ...
    var self = this;
    var selectColumns = 'Description, Address1, Address2, Phone ';
      ...
      for (var row in data) {
        template = "\
          <div class='row-fluid item-list'>\
            <div class='span12'>\
              <strong><a href="#"> + data[row][0] + "</a></strong>\
              <br />\
              " + data[row][1] + "\
              <br />\
              " + data[row][2] + "\
              ...
              " + data[row][3] + "\
              <br />\
              <a target='_blank' href='https://maps.google.com?daddr=" + data[row][1] + " , " + data[row][2] + "'>Get Directions</a> \
              <br />\
              <br />\
            </div>\
          </div>";
