...
var MapsLib = {
  ...
  fusionTableId:      "1XkxbwB-yKdiju1vzt6e045FPb2s5MVYujfPSnB1b",
  ...
  getList: function(whereClause, sortColumn) {
    var selectColumns = 'Description, Address1, Address2, Phone, Lat, Lng';
  ...
  displayList: function(json) {
    ...
    if (MapsLib.data == null) {
      ...
      for (var row in MapsLib.data) {
         template = template.concat("<tr onclick='javascript:MapsLib.openWindowTable(" + row + "); '><td>" + MapsLib.data[row][0] + "</td><td>" + MapsLib.data[row][1] + "</td><td>" + MapsLib.data[row][2] + ", " + MapsLib.data[row][3] + " " + MapsLib.data[row][4] + "</td></tr>");
  ...
  windowControl: function(e, infoWindow, map) {
    ...
    e.infoWindowHtml += "<b>" + e.row['Description'].value + "</b><br>";
    e.infoWindowHtml += "<b>Facility Type: </b>" + e.row['Address1'].value + "<br>";
    if (e.row['Description'].value != '' ) {
      e.infoWindowHtml += "<b>Servicing Railroad: </b>" + e.row['Description'].value + "<br>";
    }
    ...
    e.infoWindowHtml += "<b>State or Province: </b>" + e.row['State'].value + "<br>";
    e.infoWindowHtml += "<b>Postal Code: </b>" + e.row['Zip'].value + "<br>";
    e.infoWindowHtml += "<b>Telephone: </b>" + e.row['Phone'].value + "<br>";
    e.infoWindowHtml += "<b>Telephone: </b>" + e.row['Address2'].value + "<br>";
  ...
  openWindowTable: function(row) {
    MapsLib.infoWindow.close(map);
    thisCoordinate = MapsLib.data[row][0].split(",");
